...
const containRegExpI = new RegExp(
  srp.translation.regExpToExcludeSentenceNotNeedTranslatedContain,
  "i"
);
...
const containRegExpG2 = new RegExp(
  srp.translation.regExpToExcludeSentenceNotNeedTranslatedContain2,
  "g"
);
const exceptRegExpI = new RegExp(
  srp.translation.regExpToExcludeSentenceNotNeedTranslatedExcept,
  "i"
);
...
const exceptRegExpG2 = new RegExp(
  srp.translation.regExpToExcludeSentenceNotNeedTranslatedExcept2,
  "g"
);

const containTagNameRegExpI = new RegExp(
  srp.translation.regExpToFilterSentenceContainTagName,
  "i"
);
const addedString = srp.translation.addedString;
...
(async () => {
  ...
  const listFileName = fs.readdirSync(srp.translation.folderPath);
  let start = 0;
  let numberAsync = srp.translation.numberOfFiles;
          ...
          listFileName
            ...
            .map(async (fileName) => {
              ...
              await translateFileKs(
                `${srp.translation.folderPath}/${fileName}`,
                srp.translation.isSelects,
                srp.translation.isTagName,
                srp.encoding
              );
            })
        );
...
async function translateFileKs(filePath, isSelect, isTagName, encoding) {
  ...
  translatedFileContent = translatedFileContent.join("\n");
